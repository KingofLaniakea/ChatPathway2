"""Warm-start joint stage-2 training from the stable E020 FDHNN checkpoint."""
    ...
    run_torchrun_module(
        ...
        [
            *controlled_training_budget_args(),
            ...
            "--dynamics-init-checkpoint", seeded_asset_path("checkpoints/experiments/exp020_forced_damped_hnn_reconae_dynamics_only/dynamics_pretrain/checkpoint_best/hamiltonian_dynamics.pt"),
            "--dynamics-init-run-complete", seeded_asset_path("checkpoints/experiments/exp020_forced_damped_hnn_reconae_dynamics_only/dynamics_pretrain/run_complete.json"),
            ...
            "--save-dir", seeded_asset_path("checkpoints/experiments/exp021_forced_damped_hnn_reconae_pretrain_joint_direct/final_lora"),
        ],
    )
