...
if __name__ == "__main__":
    run_module(
        ...
        [
            ...
            "--adapter",
            "/root/autodl-tmp/checkpoints/dynamics_distilled_lora/neural_ode/checkpoint_epoch_3",
            "--input",
            "/root/autodl-tmp/data/test_7_species_dataset.csv",
            "--output",
            "/root/autodl-tmp/runs/inference/dynamics_distilled_lora/neural_ode_epoch3.csv",
        ],
    )
