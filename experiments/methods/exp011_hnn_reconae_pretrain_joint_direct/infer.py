"""Run direct generation from the validation-composite-selected E011 LoRA."""

from experiments._launch import asset_path, controlled_inference_budget_args, run_module, seeded_asset_path


if __name__ == "__main__":
    root = "checkpoints/experiments/exp011_hnn_reconae_pretrain_joint_direct/final_lora"
    run_module(
        ...
        [
            *controlled_inference_budget_args(),
            ...
            "--output", seeded_asset_path("runs/experiments/exp011_hnn_reconae_pretrain_joint_direct/direct.csv"),
            "--progress-output", seeded_asset_path("runs/experiments/exp011_hnn_reconae_pretrain_joint_direct/direct.progress.jsonl"),
        ],
    )
