...
if __name__ == "__main__":
    run_module(
        ...
        [
            "--checkpoint",
            asset_path("checkpoints/latent_dynamics_teachers/gradient_flow/gradient_flow_epoch_3.pt"),
            "--base-model",
            ...
            "--output",
            asset_path("runs/latent_dynamics_rollout/gradient_flow_scores.jsonl"),
        ],
    )
