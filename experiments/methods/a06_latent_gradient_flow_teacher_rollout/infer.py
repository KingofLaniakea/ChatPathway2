"""Score gradient-flow teacher rollouts on latent pathway trajectories."""
...
if __name__ == "__main__":
    run_module(
        ...
        [
            "--checkpoint",
            "/root/autodl-tmp/checkpoints/latent_dynamics_teachers/gradient_flow/gradient_flow_epoch_3.pt",
            "--base-model",
            ...
            "--output",
            "/root/autodl-tmp/runs/latent_dynamics_rollout/gradient_flow_scores.jsonl",
        ],
    )
