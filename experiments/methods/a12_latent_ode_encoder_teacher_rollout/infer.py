"""Score encoder-conditioned latent ODE rollouts."""
...
if __name__ == "__main__":
    run_module(
        ...
        [
            "--checkpoint",
            "/root/autodl-tmp/checkpoints/latent_dynamics_teachers/latent_ode/latent_ode_epoch_3.pt",
            "--base-model",
            ...
            "--output",
            "/root/autodl-tmp/runs/latent_dynamics_rollout/latent_ode_scores.jsonl",
        ],
    )
