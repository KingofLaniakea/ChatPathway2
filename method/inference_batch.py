...
class InferenceConfig:
    ...
    trained_lora_path = "/root/autodl-tmp/qwen3_8b_FrameworkA_1/checkpoint_epoch_2"
    
    # 数据集输入输出路径
    test_data_path = "/root/autodl-tmp/test_7_species_dataset_small.csv"
    output_data_path = "/root/autodl-tmp/test_7_species_frameworkA_small.csv"
