    ...
    for i in tqdm(range(0, len(prompts), cfg.batch_size), desc="Inferencing"):
        ...
        for j, initial in enumerate(initial_results):
            ...
            progress_record = {
                ...
                "view_id": source_row.get("view_id", source_row.get("pathway_block", "")),
                "organism": source_row.get("organism", ""),
                "pathway_family_id": source_row.get("pathway_family_id", ""),
                "source_graph_json": source_row.get("source_graph_json", ""),
                "prompt_profile": source_row.get("prompt_profile", ""),
                "organism_conditioning": source_row.get("organism_conditioning", ""),
                "entity_id_space": source_row.get("entity_id_space", ""),
                "entity_mapping_status": source_row.get("entity_mapping_status", ""),
                "prefix_horizon": source_row.get("prefix_horizon", ""),
