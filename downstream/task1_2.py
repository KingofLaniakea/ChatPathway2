...
The evaluator accepts the inference CSV produced by ``method/inference.py``.
...
from downstream.entities import extract_entities, load_synonyms, precision_recall_f1
